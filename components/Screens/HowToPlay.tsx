  ...
  return (
    <div className="how-wrap screen-slide scrollable-screen">
      ...
      <div className="how-grid">
        ...
        <div className="how-row"><span className="how-icon" style={{ color: "#bfdbfe" }}>❄</span><div><b>Freeze</b><br />Slows time by 40% for 15 seconds</div></div>
        <div className="how-row"><span className="how-icon" style={{ color: "#fb923c" }}>⚡</span><div><b>Multiplier</b><br />Double points for 24 seconds</div></div>
      </div>
