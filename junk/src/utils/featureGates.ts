...
export type FeatureId = 
  | 'evolve_mode'      // Unlock after 5 Classic games played
  | 'two_player'       // Unlock after first Classic win (score > 0, survived)
...
const FEATURE_DEFINITIONS: Record<FeatureId, Omit<FeatureGate, 'unlocked'>> = {
  evolve_mode: {
    ...
    icon: '⚡',
    unlockHint: 'Play 5 Classic games to unlock',
  ...
  two_player: {
    ...
    icon: '👥',
    unlockHint: 'Win 1 Classic game to unlock',
